...
//     geographicDistribution: v.optional(v.array(v.object({
//       location: v.object({
//         name: v.string(),              // "Central Europe", "Japan", "Amazon Basin"
//         type: v.string(),              // "continent", "country", "region", "point"
...
//         }))
//       }),
//       abundance: v.optional(v.string()),  // "rare", "common", "abundant"
//       endemic: v.optional(v.boolean()),
//       invasive: v.optional(v.boolean()),
//       nativeRange: v.optional(v.boolean()),
//       firstSighted: v.optional(v.number()), // year
//     }))),
    
//     // Legacy fields for backward compatibility
//     geographicDistributionLegacy: v.optional(v.object({
...
//     // Seasonal Activity (Heatmap Ready) 🌡️
//     seasonalActivity: v.optional(v.array(v.object({
//       month: v.string(),     // "January" - "December"
//       activity: v.number(),  // 0-100 (fruiting likelihood)
//       stage: v.optional(v.string()), // "dormant", "growing", "fruiting", "sporulating"
//     }))),
    
//     // Biodiversity Trend (Timeseries) 📈
//     biodiversityTrend: v.optional(v.array(v.object({
//       year: v.number(),
//       abundance: v.number(),   // 0-100 relative abundance
...
//       dayOffset: v.number(),              // Days from inoculation (0 = start)
//       stage: v.string(),                  // "inoculation", "colonization", "pinning", "fruiting", "harvest"
//       label: v.string(),                  // Display name
//       description: v.optional(v.string()),
//       temperature: v.optional(v.number()),
//       humidity: v.optional(v.number()),
//       milestone: v.optional(v.boolean()), // Highlight important events
//     }))),
...
//       yieldProgress: v.optional(v.number()),        // 0-100% of potential
...
//       contaminationRate: v.optional(v.number()), // 0-100%
//       profitability: v.optional(v.number()),     // score 0-100
//     }))),
//   })),
...
//       axis: v.string(),        // "Protein", "Carbs", "Fiber", "Vitamins", "Minerals"
...
//       category: v.string(),    // "Proteins", "Carbs", "Fats", "Fiber", "Water"
//       percentage: v.number(),  // 0-100, sum should be 100
//       grams: v.optional(v.number()), // per 100g
//     }))),
//   })),
...
//       price: v.number(),
//       currency: v.string(),
//       marketSegment: v.optional(v.string()), // "fresh", "dried", "extract"
//     }))),
//   })),
...
//   // ===== RATINGS & SCORES (Progress/Radar Ready) 📊 =====
//   ratings: v.optional(v.object({
//     flavorIntensity: v.optional(v.number()),      // 0-10
//     cultivationDifficulty: v.optional(v.number()), // 0-10 (10 = very difficult)
//     medicinalPotency: v.optional(v.number()),     // 0-10
//     nutritionalValue: v.optional(v.number()),     // 0-10
//     commercialViability: v.optional(v.number()),  // 0-10
//     researchInterest: v.optional(v.number()),     // 0-10
//     conservationPriority: v.optional(v.number()), // 0-10
//     beginnerFriendly: v.optional(v.number()),     // 0-10 (10 = very beginner-friendly)
//   })),
  
//   // Completeness Scores by Perspective
//   completenessScores: v.optional(v.object({
//     physicalCharacteristics: v.optional(v.number()),  // 0-100%
