...
**Uses:**
- `../../styles/tokens.js` - Global design tokens
- `../../../core/AmorphSystem.js` - Event publishing & perspective state
- `../../../features/search-system/reactors/` - Listens to search:completed events
...
**See also:**
- `../../../features/perspective-system/` - PerspectiveHost responds to perspective events
- `../../../features/search-system/` - Both SearchReactors publish matched perspectives
- `../../../shared/observers/GlobalObserver.js` - Handles global:* events
