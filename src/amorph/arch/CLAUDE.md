...
Der `arch/` Ordner enthält die Kern-Komponenten des AMORPH Systems:

1. **AmorphSystem.js** - Das Gehirn des Systems
2. **RedisEventBridge.js** - Event Bus mit Redis Streams & Consumer Groups
3. **convex.ts** - Convex Client für SSR Data Fetching
4. **layouts/** - Astro Layout Components
5. **styles/** - Global Design System (NEW!)
